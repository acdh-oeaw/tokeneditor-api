         ...
         <div class="container" style="width:90%;"  ng-controller="MainCtrl" >
             <div class="row">
              ...
              <span class="text-muted"><div ng-controller="DoughnutCtrl">
                        <canvas id="doughnut" ng-if="{{$scope.creategrid}}"  class="chart chart-doughnut" data="data" labels="labels"></canvas> 
                    </div>
                     </span>
                </div>
                <div class="col-md-9">
                    <div id="grid1" ng-if='{{$scope.creategrid}}' ui-grid="gridOptions"  ui-grid-selection gri ui-grid-edit ui-grid-cellnav ui-grid-pagination ui-grid-exporter class="gridstyle"></div>
